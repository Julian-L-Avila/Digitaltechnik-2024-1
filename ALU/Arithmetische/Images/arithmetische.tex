...
\begin{tikzpicture}
	...
	\node (MUX2Z4) [font=\scriptsize, below of=MUX2X1, shift={(-.0, -.5)}] {$Z_4$};
	\node (MUX2Z3) [font=\scriptsize, right of=MUX2Z4, shift={(-.5, 0)}] {$Z_3$};
	\node (MUX2Z2) [font=\scriptsize, right of=MUX2Z3, shift={(-.5, 0)}] {$Z_2$};
	\node (MUX2Z1) [font=\scriptsize, right of=MUX2Z2, shift={(-.5, 0)}] {$Z_1$};
	\node (MUX2Z0) [font=\scriptsize, right of=MUX2Z1, shift={(-.5, 0)}] {$Z_0$};
	...
	\draw (MUX2Z4) -- ++(0, -.75) -- ++(-1, 0) -- ++(0, -1) to [font=\scriptsize, leDo, l_=$Z_4$, fill=Plum] ++(0, -3) -- ++(2, 0);
	\draw (MUX2Z3) -- ++(0, -1.25) -- ++(-.5, 0) -- ++(0, -.5) to [font=\scriptsize, leDo, l_=$Z_3$, fill=Plum] ++(0, -3) node[circ] { };
	\draw (MUX2Z2) -- ++(0, -1.75) to [font=\scriptsize, leDo, l_=$Z_2$, fill=Plum] ++(0, -3) node[circ](Z) { };
	\draw (MUX2Z1) -- ++(0, -1.25) -- ++(.5, 0) -- ++(0, -.5) to [font=\scriptsize, leDo, l_=$Z_1$, fill=Plum] ++(0, -3) node[circ] { };
	\draw (MUX2Z0) -- ++(0, -.75) -- ++(1, 0) -- ++(0, -1) to [font=\scriptsize, leDo, l_=$Z_0$, fill=Plum] ++(0, -3) -- ++(-2, 0);

	\node [ground, draw] at (Z) { };
